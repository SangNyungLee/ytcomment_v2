	...
	<div className="myPageContainer">
		...
		<div className="border-t p-4 mt-4">
			...
			{[1, 2, 3].map((_, i) => (
				...
				<div className="scrap-thumbnail"></div>
				<div className="scrap-info">
					<h4 className="text-sm font-semibold">스크랩된 영상 제목 {i + 1}</h4>
					<p className="text-xs text-gray-500">조회수 5.2만</p>
					<div className="scrap-buttons">
					<button className="scrap-more">더보기</button>
					<button className="scrap-action">스크랩</button>
					</div>
				</div>
				</div>
			))}
