...
public class YoutubeController {
    ...
    private final DetailPageInfoService detailPageInfoService;
    ...
    @PostMapping("/getTags")
    public DetailPageInfoDTO.Out getDetailPageTags(@RequestBody DetailPageInfoDTO.In in) {
        return detailPageInfoService.getDetailPageInfoByVideoId(in);
    }
